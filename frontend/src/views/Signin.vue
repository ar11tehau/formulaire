...
<template>
   <div class="flex flex-col w-fit m-auto">
      ...
      <div class="flex justify-end">
         <button @click="login(formData)" :disabled="isFormValid" class="flex w-fit bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline disabled:bg-blue-200 mr-3" type="submit">Valider</button>
      </div>
   </div>
</template>